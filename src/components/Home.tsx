      ...
      >
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h2 className={`text-4xl font-bold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>
            Mash<span className="font-serif font-medium">(d)</span> for Mathematical Visualization
          </h2>
          ...
          <button
            onClick={onCreateNew}
            className="flex items-center gap-2 px-8 py-2 bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:via-indigo-600 hover:to-purple-700 transition-all duration-300 ease-in-out shadow-md hover:shadow-lg text-lg mx-auto font-medium">
            <Plus size={24} />
            Create New
          </button>
        </div>
            ...
            {knots.map((knot) => (
              ...
              >
                ...
                {hoverPosition.isHovering && hoverPosition.elementId === knot.id && (
                  <div 
                    className="absolute rounded-full pointer-events-none filter blur-2xl opacity-15 bg-gradient-to-r from-blue-500 via-purple-400 to-blue-400"
                    style={{
                      width: '300px',
                      height: '300px',
